...
namespace Dial4Jobz.Tests.Controllers
{
    ...
    public class AccountControllerTest
    {
        ...
        public void Register_Post_ReturnsRedirectOnSuccess()
        {
            ...
            RegisterModel model = new RegisterModel()
            {
                ...
                Email = "goodEmail",
                Password = "goodPassword",
                MobileNumber="goodMobile",
                ConfirmPassword = "goodPassword"
            };

            // Act
            ActionResult result = controller.SignUp(model, null, null,null);
        ...
        public void Register_Post_ReturnsViewIfModelStateIsInvalid()
        {
            ...
            controller.ModelState.AddModelError("Entry is invalid.Please check all fields.", "Dummy error message.");
        ...
        private class MockMembershipService : IMembershipService
        {
            ...
            public MembershipCreateStatus CreateOrganization(string userName, string password, string email, string mobilenumber, string name, string contactPerson, int organizationId, string phVerficationCode, int employerType)
            {
                if (userName == "duplicateUser")
                {
                    return MembershipCreateStatus.DuplicateUserName;
            ...
            //public MembershipCreateStatus CreateCandidate(string userName, string password, string email, string mobilenumber, string phVerficationNo)
            //{
            //    throw new NotImplementedException();
            //}
