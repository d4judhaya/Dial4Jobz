...
$(document).ready(function () {
 ...
 function Databind(Pdestroy, fromDate, toDate) {
     ...
     var oTable = $('.datatable').dataTable({
         ...
         'sAjaxSource': '/Admin/ConsultantReport/ListConsultantsReports?fromDate=' + fromDate + '&toDate=' + toDate, 
         "bFilter": true,
         "aaSorting": [[3, 'desc']], 
         "aoColumnDefs": [{ 'bSortable': false, 'aTargets': [2, 3, 4, 5, 6,7,8]}],
         "aoColumns": [{ 'sWidth': '15%', 'sClass': 'left' }, { 'sWidth': '10%', 'sClass': 'center' }, { 'sWidth': '20%', 'sClass': 'left' }, { 'sWidth': '20%', 'sClass': 'left' }, { 'sWidth': '10%', 'sClass': 'center' }, { 'sWidth': '5%', 'sClass': 'center' }, { 'sWidth': '10%', 'sClass': 'left'},{ 'sWidth': '10%', 'sClass': 'left'}],
 ...
 function ConfirmDelete() {
   ...
   function Delete(id) {
    ...
    if (!ConfirmDelete())
        ...
        $.ajax({
            url: '/Admin/ConsultantReport/Delete',
            type: 'POST',
            data: { 'id': id },
            datatype: 'json',
