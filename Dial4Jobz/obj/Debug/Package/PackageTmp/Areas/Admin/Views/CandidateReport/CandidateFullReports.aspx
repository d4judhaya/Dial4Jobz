...
<head id="Head1" runat="server">
    <title>Candidates Full Reports</title>
...
<script type="text/javascript">
    ...
    function Databind(Pdestroy, fromDate, toDate) {
        ...
        var oTable = $('.datatable').dataTable({
            ...
            'sAjaxSource': '/Admin/CandidateReport/ListCandidateFullReports?fromDate=' + fromDate + '&toDate=' + toDate,
            "bFilter": true,
            "aaSorting": [[5, 'desc']],
