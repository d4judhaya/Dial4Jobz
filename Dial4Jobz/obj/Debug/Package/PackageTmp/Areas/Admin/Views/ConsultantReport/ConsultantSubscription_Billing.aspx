...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Consultant Subscription_Billing
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

   <h2>Consultant Subscription Billing Details</h2>
    ...
    <table>
        ...
        <tbody>
            <%  int i = 0;
                foreach (Dial4Jobz.Models.OrderDetail orderdetail in new Dial4Jobz.Models.Repositories.VasRepository().GetOrderDetailsbyConsultantId(ViewData["LoggedConsultant"] != null ? Convert.ToInt32(ViewData["LoggedConsultant"].ToString()) : 0))
               {
                   i++; %>
               ...
               <tr>
                ...
                <%} %>         
                <td>
                    <a class="callpickupcash" href="<%: Url.Action("Invoice", "ConsultantReport", new { orderId = orderdetail.OrderId }) %>">Print Invoice</a>
                </td>
                </tr>
            <% } %>
        </tbody>
