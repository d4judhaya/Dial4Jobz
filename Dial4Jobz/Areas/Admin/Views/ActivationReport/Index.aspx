...
<head id="Head1" runat="server">
    <title>Dial4jobz :: Activate Employer Orders</title>
...
<script type="text/javascript">
    ...
    function Databind(Pdestroy, fromDate, toDate) {
        ...
        var oTable = $('.datatable').dataTable({
            ...
            'sAjaxSource': '/Admin/ActivationReport/ListActivationEmployerReports?fromDate=' + fromDate + '&toDate=' + toDate,
            "bFilter": true,
            "aaSorting": [[3, 'desc']],
    ...
    function ConfirmSend() {
     ...
     function SendRemainder() { debugger;
        var orderId = "";
        var count = 0;
        $("input:checkbox[name=ActivateOrder]:checked").each(function () {
            if (count == 0) {
        ...
        $("#loading").show();
        var data = "OrderIds=" + orderId;
        var url = '<%= Url.Action("EmployerReminder", "AdminHome","Admin") %>';
...
<div id="wrapper">  
    ...
    <h2>Employer Activation Report</h2>
            ...
            <tr>
                <td style="width:35%;" align="right" valign="middle">
                    ...
                    <td style="width:35%;" align="center" valign="middle" class="editor-field">
                     ...
                     <% var sumAmount = _vasRepository.GetSumOfAmount();%>
                     <% var datewiseAmount = _vasRepository.GetSumAmountActivationForEmployer(); %>
