...
<script type="text/javascript">
    ...
    function Databind(Pdestroy, fromDate, toDate) {
        ...
        var oTable = $('.datatable').dataTable({
            ...
            'sAjaxSource': '/Admin/AdminHome/ListContactViewedLogs?fromDate=' + fromDate + '&toDate=' + toDate + '&organizationId=' + '<%:Convert.ToInt32(ViewData["LoggedInOrganization"])%>' + '&consultantId=' + '<%:Convert.ToInt32(ViewData["LoggedInConsultant"])%>',
            "bFilter": true,
            "aaSorting": [[5, 'desc']],
...
<body>
    ...
    <div id="main">    
    <h2>Viewed Candidates List For HORS</h2>
