...
<head id="Head1" runat="server">
    <title>Job Alert Sent List</title>
...
<script type="text/javascript">
    ...
    function Databind(Pdestroy, fromDate, toDate) {
        ...
        var oTable = $('.datatable').dataTable({
            ...
            'sAjaxSource': '/Admin/AdminHome/ListAlertSentDetailsForRAJ?fromDate=' + fromDate + '&toDate=' + toDate + '&candidateId=' + '<%:Session["LoggedInCandidate"] %>',
            "bFilter": true,
            "aaSorting": [[7, 'desc']],
            //"aoColumnDefs": [{ 'bSortable': false, 'aTargets': [1, 3, 4, 5, 6, 7]}],
            "aoColumns": [{ 'sWidth': '15%', 'sClass': 'left' }, { 'sWidth': '15%', 'sClass': 'center' }, { 'sWidth': '20%', 'sClass': 'left' }, { 'sWidth': '20%', 'sClass': 'left' }, { 'sWidth': '10%', 'sClass': 'left' }, { 'sWidth': '10%', 'sClass': 'center' },{ 'sWidth': '15%', 'sClass': 'center'}, { 'sWidth': '15%', 'sClass': 'center'}],
            ...
            <tbody>
                <tr>
                    <td colspan="6" class="dataTables_empty">
                        <img alt="Please Wait..." src="<%=Url.Content("~/Areas/Admin/Content/Images/ajax_loader1.gif")%>" height="50" />
                    </td>
                </tr>
            </tbody>
        </table>
