                        ...
                        <span>My Jobs Listing</span> </a>
                         ...
                         <a href="../../../../../Search/CandidateSearch" class="dashboard-module" target="_blank">
                           ...
                           <span>Search Job Seekers</span> </a>
                               ...
                               <a class="dashboard-module" href="<%: System.Configuration.ConfigurationManager.AppSettings["SiteFullURL"].ToString() %>/Jobs/JobsViewedList?organizationId=<%:organizationId %>" target="_blank">
                                ...
                                <a href="../../../Admin/AdminHome/AdminPlans" class="dashboard-module" target="_blank">
                                    ...
                                    <a href="" class="dashboard-module" target="_blank">
                                        ...
                                        <span>Advertise in emails</span> </a><a href="<%:Url.Action("Index","EmployerVas") %>" class="dashboard-module" target="_blank">
                                            ...
                                            <a href="<%:Url.Action("AdminAlertSentDetails","AdminHome", new { organizationId= organizationId, consultantId= 0}) %>" class="dashboard-module" target="_blank">
                                            ...
                                            <a href="<%:Url.Action("AdminViewedCandidatesList","AdminHome", new { organizationId= organizationId, consultantId= 0}) %>" class="dashboard-module" target="_blank">
