...
<script type="text/javascript">
    ...
    function Databind(Pdestroy, fromDate, toDate) {
        ...
        var oTable = $('.datatable').dataTable({
            ...
            'sAjaxSource': '/Admin/AdminHome/ListAlertSentDetails?fromDate=' + fromDate + '&toDate=' + toDate + '&organizationId=' + '<%:Convert.ToInt32(ViewData["LoggedInOrganization"])%>' + '&consultantId=' + '<%:Convert.ToInt32(ViewData["LoggedInConsultant"])%>',
            "bFilter": true,                
            "aaSorting": [[5, 'desc']],
