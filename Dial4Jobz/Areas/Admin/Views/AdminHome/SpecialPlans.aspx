...
<% Dial4Jobz.Models.Permission adminPermission = new Dial4Jobz.Models.Permission();
   ...
   IEnumerable<Dial4Jobz.Models.AdminPermission> pageaccess = _repository.GetPermissionsbyUserId(user.Id);
                string pageAccess = "";
                string[] Page_Code = null;
                foreach (var page in pageaccess)
                {
                    adminPermission = _repository.GetPermissionsNamebyPermissionId(Convert.ToInt32(page.PermissionId));
...
<%if (user.UserName == "admin123" || Page_Code.Contains("Allow Special Plans"))
  { %>
