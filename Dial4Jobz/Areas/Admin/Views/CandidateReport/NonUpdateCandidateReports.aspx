...
<head id="Head1" runat="server">
    <title>Not Updated Candidates</title>
...
<script type="text/javascript">
    ...
    function Databind(Pdestroy, fromDate, toDate) {
        ...
        var oTable = $('.datatable').dataTable({
            ...
            'sAjaxSource': '/Admin/CandidateReport/ListNonUpdateCandidateReports?fromDate=' + fromDate + '&toDate=' + toDate,
            "bFilter": true,
            "aaSorting": [[5, 'desc']],
...
<body>
    ...
    <h2>Hidden / Not Updated Candidates Reports</h2>
