...
<body>
    ...
    <% using (Html.BeginForm("CreatePartner", "Channel", FormMethod.Post))
       { %>
              <div class="editor-label">
                  Name of the Channel <span class="red">*</span>  
              </div>
              ...
              <div class="editor-label">
                  Email Id (Taking as a UserName) <span class="red">*</span>  
              </div>
              <div class="editor-field">
                   <%: Html.TextBoxFor(model => model.Email, new { maxlength = "30" })%> 
              </div>
              <div class="editor-label">
              ...
              <div class="editor-field">
                   <%: Html.TextBoxFor(model => model.ContactNo, new { maxlength = "10" })%> 
              </div>
