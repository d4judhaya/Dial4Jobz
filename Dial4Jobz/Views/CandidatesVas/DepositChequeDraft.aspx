...
<script type="text/javascript">
 ...
 <body>
  <div style="width:650px;padding-left:20px;">    
   <% Html.BeginForm("DepositChequeDraft", "candidates/candidatesvas", FormMethod.Post, new { @id = "Save" });
      { %>
        <center> <h3>Deposit /send us a Cheque or Draft</h3></center>
            <p>If your city has a branch of <b>ICICI Bank Ltd </b> you can pay us by local cheque. Prepare a cheque drawn in favour of <b>Dial4Jobz India Private Ltd</b> and deposit the same in your city's <b>ICICI Bank</b>
         <p>
            Current Account:
