 ...
 <tr>
  ...
  <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width="100%"
   ...
   height=98 id="Picture 3" src="../../Content/Images/logo_with_number.jpg"
    ...
    color:black'><br/>
    </span><span style='font-size:10.5pt;font-family:"Times New Roman","serif";
  ...
  <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width="100%"
   ...
   <tr>
    ...
    To: &nbsp;<%: Model.OrderMaster.Candidate.Name %></span></b><b><span style='font-size:9.0pt;
    font-family:"Times New Roman","serif"'><br>
    </span></b><b><span style='font-size:9.0pt;font-family:"Times New Roman","serif"'><%: Model.OrderMaster.Candidate.Address %>
    &nbsp;</span></b><b><span style='font-size:9.0pt;font-family:"Times New Roman","serif"'><br>
    </span></b><b><span style='font-size:9.0pt;font-family:"Times New Roman","serif"'><%: Model.OrderMaster.Candidate.Pincode %>    </span></b><br />
    <span style='font-size:9.0pt;font-family:"Times New Roman","serif"'><%: Model.OrderMaster.Candidate.ContactNumber %>    </span><br />
   ...
   <tr>
    ...
    color:black'><b>Date :</b></span><span style='font-size:9.0pt;font-family:"Times New Roman","serif"'>&nbsp;
    <%if (Model.OrderMaster.OrderDate != null)
    ...
    color:black'>Customer ID: <%: Model.OrderMaster.Candidate.Id %></span></p>
    </td>
   </tr>
  </table>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
     ...
     <tr>
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr>
        ...
        .0001pt;text-align:center;line-height:normal'><span style='font-size:
        8.5pt;font-family:"Times New Roman","serif";color:black'>
        <% double discountValue = ((exactValue * 25 / 100)); %>
        <%if (Model.OrderMaster.InvoiceId == null)
          { %>
      ...
      <td width="10%" style='width:10.38%;border:solid #E1E1E3 1.0pt;
       ...
       <%if (Model.DiscountAmount != null)
          { %>
             Amount in words (INR.):&nbsp;<% string words = Dial4Jobz.Helpers.StringHelper.NumbersToWords(Convert.ToInt32(Model.DiscountAmount.Value)); %><%: words%> only
        <% }
          else
          {%>
           <% if (orderpayment != null && orderpayment.OrderMaster.PaymentStatus == true)
              { %> 
                Received Amount in words (INR.):&nbsp;<% string words = Dial4Jobz.Helpers.StringHelper.NumbersToWords(Convert.ToInt32(Model.Amount.Value)); %><%: words%> only
           <%} else { %>
