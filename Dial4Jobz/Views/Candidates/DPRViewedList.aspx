...
<script type="text/javascript">
    ...
    function Databind(Pdestroy, fromDate, toDate) {
        ...
        var oTable = $('.datatable').dataTable({
            ...
            'sAjaxSource': '/Candidates/ListDPRViewedList?fromDate=' + fromDate + '&toDate=' + toDate + '&candidateId=' + '<%=ViewData["CandidateId"] %>',
            "bFilter": true,
            "aaSorting": [[4, 'desc']],
            //"aoColumnDefs": [{ 'bSortable': false, 'aTargets': [1, 3, 4, 5, 6, 7]}],
            "aoColumns": [{ 'sWidth': '15%', 'sClass': 'left' }, { 'sWidth': '15%', 'sClass': 'center' }, { 'sWidth': '20%', 'sClass': 'left' }, { 'sWidth': '20%', 'sClass': 'left' }],
            ...
            "fnPreDrawCallback": function () {
                $('.datatable tbody').html('<tr><td colspan="4" class="dataTables_empty"><img alt="Please Wait..." src="<%=Url.Content("~/Areas/Admin/Content/Images/ajax_loader1.gif")%>"  height="50" /></td></tr>');
                return true;
            }
        });
...
<body>
    ...
    <div id="main">    
    <h2>Viewed Employer Details List</h2>
