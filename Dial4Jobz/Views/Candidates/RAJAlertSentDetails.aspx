...
<script type="text/javascript">
    ...
    function Databind(Pdestroy, fromDate, toDate) {
        ...
        var oTable = $('.datatable').dataTable({
            ...
            'sAjaxSource': '/Candidates/ListAlertSentDetails?fromDate=' + fromDate + '&toDate=' + toDate,
            "bFilter": true,
            "aaSorting": [[7, 'desc']],
            //"aoColumnDefs": [{ 'bSortable': false, 'aTargets': [1, 3, 4, 5, 6, 7]}],
            "aoColumns": [{ 'sWidth': '15%', 'sClass': 'left' }, { 'sWidth': '15%', 'sClass': 'center' }, { 'sWidth': '20%', 'sClass': 'left' }, { 'sWidth': '20%', 'sClass': 'left' }, { 'sWidth': '20%', 'sClass': 'left' }, { 'sWidth': '10%', 'sClass': 'center' }, { 'sWidth': '15%', 'sClass': 'center' }, { 'sWidth': '15%', 'sClass': 'center'}],
...
<body>
    ...
    <div id="main">    
    <h2>Resume Alert Sent Details</h2>
