...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tbody>
            <%  int i = 0;
                foreach (Dial4Jobz.Models.OrderDetail orderdetail in new Dial4Jobz.Models.Repositories.VasRepository().GetOrderDetailsbyOrgId(ViewData["LoggedConsultant"] != null ? Convert.ToInt32(ViewData["LoggedConsultant"].ToString()) : 0))
               {
                   i++; %>
