 ...
 <tr>
  ...
  <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width="100%"
   ...
   <tr>
    ...
    To: &nbsp;<%: Model.OrderMaster.Organization.Name %></span></b><b><span style='font-size:9.0pt;
    font-family:"Times New Roman","serif"'><br/>
    </span></b><b><span style='font-size:9.0pt;font-family:"Times New Roman","serif"'><%: Model.OrderMaster.Organization.Address %>
    &nbsp;</span></b><b><span style='font-size:9.0pt;font-family:"Times New Roman","serif"'><br/>
    </span></b><b><span style='font-size:9.0pt;font-family:"Times New Roman","serif"'><%: Model.OrderMaster.Organization.Pincode %>    </span></b>
      <br />
     <span style='font-size:9.0pt;font-family:"Times New Roman","serif"'><%: Model.OrderMaster.Organization.MobileNumber %>
    </p>
    </td>
    <td style='border:none;padding:1.5pt 1.5pt 1.5pt 1.5pt'>
    <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;
   ...
   <tr>
    ...
    color:black'>Customer ID: <%: Model.OrderMaster.Organization.Id %></span></p>
    </td>
   </tr>
  </table>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
