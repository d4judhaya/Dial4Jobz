...
<script type="text/javascript">
    ...
    function Databind(Pdestroy, fromDate, toDate) {
        ...
        var oTable = $('.datatable').dataTable({
            ...
            'sAjaxSource': '/Employer/ListContactViewedLogs?fromDate=' + fromDate + '&toDate=' + toDate,
            "bFilter": true,
            "aaSorting": [[5, 'desc']],
            "aoColumnDefs": [{ 'bSortable': false, 'aTargets': [1, 3, 4, 5,6,7]}],
            "aoColumns": [{ 'sWidth': '15%', 'sClass': 'left' }, { 'sWidth': '15%', 'sClass': 'center' }, { 'sWidth': '10%', 'sClass': 'left' }, { 'sWidth': '15%', 'sClass': 'left' }, { 'sWidth': '13%', 'sClass': 'left' }, { 'sWidth': '10%', 'sClass': 'center' }, { 'sWidth': '20%', 'sClass': 'center' }, { 'sWidth': '10%', 'sClass': 'center'}],
