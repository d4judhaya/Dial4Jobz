...
<body>
  <!--  <form method="post" name="customerData" action="ccavRequestHandler.aspx">-->
    <%--<form method="post" name="customerData" action="CCAVRequest.ascx">--%>

    <% Html.BeginForm("CCAVRequest", "CCAVPayment", FormMethod.Post, new { @id = "payment" });
       { %>
        ...
        <table width="40%" height="100" border='1' align="center">
             ...
             <tr>
                <td>Merchant Id</td>
                <td><input type="text" name="merchant_id" id="merchant_id" value="34702"/></td>
             </tr>
             <tr>
                <td>Order Id</td>
             ...
             <tr>
                ...
                <td><input type="text" name="redirect_url" value="http://www.dial4jobz.in/Employer/EmployerVas/Payment"/></td>
             </tr>
	         <tr>
                <td>Cancel URL</td>
                <td><input type="text" name="cancel_url" value="http://192.168.0.96/mcpg_new/iframe/ccavResponseHandler.php"/></td>
             </tr>
             <tr>
             ...
             <tr>
                <td>Billing Tel:</td>
                <td><input type="text" name="billing_tel" value="9595226054"/></td>
             </tr>
             <tr>
                <td>Billing Email:</td>
                <td><input type="text" name="billing_email" value="atul.kadam@avenues.info"/></td>
             </tr>
             <tr>
             ...
             <tr>
                <td>Shipping Tel:</td>
                <td><input type="text" name="delivery_tel" value="9595226054"/></td>
             </tr>
             <tr>
