  ...
  <head>
    ...
    <script language="C#" runat="server">
        public void display()
        {
            ...
            {
                //Response.Redirect("http://www.dial4jobz.in/employer/employervas/index?value=" + EncryptString(oPgResp.TxnId.ToString()), true);
                Response.Redirect("http://www.dial4jobz.in/employer/employervas/EmployerPayment?value=" + EncryptString(oPgResp.TxnId.ToString()), true);
            }

            else
            {
                Response.Redirect("http://www.dial4jobz.in/employer/employervas/EmployerPayment?value=" + 0);
